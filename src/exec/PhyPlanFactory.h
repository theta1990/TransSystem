...
public:
	...
	int32_t genInsertPlan(PhyPlan *&plan, std::vector<RowObj> objList, RowTable *table);
	...
	int32_t genInsertPlan(PhyPlan *&plan, std::vector<RowObj> objList, int32_t tableId);
