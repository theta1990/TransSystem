...
int32_t PhyPlanFactory::genInsertPlan(PhyPlan *&plan, char *inputValues, int32_t sz, RowTable* table) {
...
int32_t PhyPlanFactory::genSelectPlan(PhyPlan *&plan, char *inputValues, int32_t sz, RowTable *table) {
 ...
 */
int32_t PhyPlanFactory::genUpdatePlan(PhyPlan *&plan, char *inputValues, int32_t sz ,Expression *expr, RowTable *table) {
